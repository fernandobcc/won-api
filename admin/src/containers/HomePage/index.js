...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/fernandobcc/won-api/',
  },
  {
    name: 'Twitter',
    link: 'https://twitter.com/fernando_bcc',
  },
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>You can insert different games, categories and publishers on our page!!</P>
